...
> 
> **Environment Selection**: A console menu will appear for you to select your Power BI environment:
> - Choose from 6 options: `Public` (default), `Germany`, `USGov`, `China`, `USGovHigh`, or `USGovMil`
> - Enter the number (1-6) or press **Enter** for default (Public)
> - If no selection is made after 120 seconds, it will automatically continue with the default of Public.
...
> 
> When you run the script, a numbered console menu will appear for you to select your environment (or default to Public after 120 seconds). The script automatically uses the correct API endpoints for all Power BI, Fabric, and XMLA connections.
